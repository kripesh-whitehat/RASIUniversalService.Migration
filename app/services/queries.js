module.exports = [
  ...
  // RSIUDB
  {
    database: 'RSIUDB',
    tableowner: 'dbo',
    table: '_FocusSettings',
    sql: id => `from RSIUDB.dbo._FocusSettings where UnitID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'BACKPOLL_SCHEDULE',
    sql: id => `from RSIUDB.RSIUDB.BACKPOLL_SCHEDULE where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'GLACCOUNTS_RSI',
    sql: id => `from RSIUDB.RSIUDB.GLACCOUNTS_RSI where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'GLACCOUNTS_RSI_2',
    sql: id => `from RSIUDB.RSIUDB.GLACCOUNTS_RSI_2 where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'JOB_CODE_RSI',
    sql: id => `from RSIUDB.RSIUDB.JOB_CODE_RSI where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'LKJOURNALSETUP',
    sql: id => `from RSIUDB.RSIUDB.LKJOURNALSETUP where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'LOCATION_DM',
    sql: id => `from RSIUDB.RSIUDB.LOCATION_DM where COMPANY_ID = ${id}`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'UNIT_DIVISION_REL',
    sql: id => `from RSIUDB.RSIUDB.UNIT_DIVISION_REL where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'dbo',
    table: 'RPTReportSetUp',
    sql: id => `FROM RSIUDB.dbo.RPTReportSetUp WHERE CorpId = ${id}`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'LOCATION_DM_2',
    sql: id => `FROM RSIUDB.RSIUDB.LOCATION_DM_2 where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSIUDB',
    tableowner: 'RSIUDB',
    table: 'LOCATION_JOB_REF',
    sql: id => `FROM RSIUDB.RSIUDB.LOCATION_JOB_REF where Unit_ID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },

  // api_credentials
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'BreadcrumbCredentials',
    sql: id => `from api_credentials.dbo.BreadcrumbCredentials where UnitID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'DelagetLocation',
    sql: id => `from api_credentials.dbo.DelagetLocation where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'HeartlandLocations',
    sql: id => `from api_credentials.dbo.HeartlandLocations where UnitID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'PosDbLocations',
    sql: id => `from api_credentials.dbo.PosDbLocations where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'RpowerCredentials',
    sql: id => `from api_credentials.dbo.RpowerCredentials where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'SquareCredentials',
    sql: id => `from api_credentials.dbo.SquareCredentials where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'ToastCredentials',
    sql: id => `from api_credentials.dbo.ToastCredentials where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'TwoTouchCredentials',
    sql: id => `from api_credentials.dbo.TwoTouchCredentials where UnitID in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'ToastAuthorization',
    sql: id => `from api_credentials.dbo.ToastAuthorization where ClientId in (Select ClientId from api_credentials.dbo.ToastCredentials where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id}))`
  }, 
  {
    database: 'api_credentials',
    tableowner: 'dbo',
    table: 'ToastPartnerAuthorization',
    sql: id => `from api_credentials.dbo.ToastPartnerAuthorization where ClientId in (Select ClientId from api_credentials.dbo.ToastCredentials where UnitId in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id}))`
  },   

  // RSI_ShiftSolutions_LIVE
  {
    database: 'RSI_ShiftSolutions_LIVE',
    tableowner: 'dbo',
    table: 'tbl_Users',
    sql: id => `from RSI_ShiftSolutions_LIVE.dbo.tbl_Users where CustomerGroupId in (Select Id from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerGroups where Id in (Select CustomerGroupId from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerDivisions where Id in (Select CustomerDivisionId from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerUnits where Number in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id}))))`
  },
  {
    database: 'RSI_ShiftSolutions_LIVE',
    tableowner: 'dbo',
    table: 'tbl_UsersCustomerUnits',
    sql: id => `from RSI_ShiftSolutions_LIVE.dbo.tbl_UsersCustomerUnits where CustomerUnitId in (Select Id from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerUnits where Number in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id}))`
  },
  {
    database: 'RSI_ShiftSolutions_LIVE',
    tableowner: 'dbo',
    table: 'tbl_CustomerUnits',
    sql: id => `from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerUnits where Number in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})`
  },
  {
    database: 'RSI_ShiftSolutions_LIVE',
    tableowner: 'dbo',
    table: 'tbl_CustomerGroups',
    sql: id => `from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerGroups where Id in (Select CustomerGroupId from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerDivisions where Id in (Select CustomerDivisionId from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerUnits where Number in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id})))`
  },
  {
    database: 'RSI_ShiftSolutions_LIVE',
    tableowner: 'dbo',
    table: 'tbl_CustomerDivisions',
    sql: id => `from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerDivisions where Id in (Select CustomerDivisionId from RSI_ShiftSolutions_LIVE.dbo.tbl_CustomerUnits where Number in (select UnitID from RSIAccounting.dbo.Unit where CorporateID = ${id}))`
  },
]